            ...
            var roleList = new List<Role>
                    {
                        ...
                        new Role {RoleId = Convert.ToInt32(RoleEnum.User), RoleName = RoleEnum.User.ToString(), CreatedBy = Convert.ToInt32(UserEnum.SuperAdmin), CreatedDate = DateTime.Now, UpdatedBy = Convert.ToInt32(UserEnum.SuperAdmin), UpdatedDate = DateTime.Now, IsDelete = false, DeletedBy = Convert.ToInt32(UserEnum.SuperAdmin), DeletedDate = DateTime.Now}
