...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /**
     * is returns a bool for if typeof obj is exactly type.
     */
    ...
    /**
     * contains returns a bool for if substr is found within str.
     */
    ...
    for ( var feature in tests ) {
        if ( hasOwnProp(tests, feature) ) {
            ...
            //   then based on that bool, define an appropriate className
