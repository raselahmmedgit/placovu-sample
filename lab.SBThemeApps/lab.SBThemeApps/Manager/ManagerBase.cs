...
namespace lab.SBThemeApps.Manager
{
    public class ManagerBase<T> : IManagerBase<T> where T : class
    {
        ...
        #region Constructor
        //public ManagerBase(IRepositoryBase<T> iRepositoryBase, IUnitOfWork iUnitOfWork)
        //{
        //    this._iRepositoryBase = iRepositoryBase;
        //    //this._iUnitOfWork = iUnitOfWork;
        //}

        public ManagerBase(IRepositoryBase<T> iRepositoryBase, AppDbContext dbContext)
        {
            this._iRepositoryBase = iRepositoryBase;
